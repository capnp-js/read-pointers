...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-read-pointers.js",
      format: "umd",
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-read-pointers.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-read-pointers.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-read-pointers.js.map",
            },
          }))
